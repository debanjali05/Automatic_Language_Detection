CREATE DATABASE `ita_wikipedia_2016_30K`;

USE ita_wikipedia_2016_30K;
...
CREATE TABLE `words` (
  ...
  KEY `word` (`word`),
  KEY `w_id` (`w_id`)
) ENGINE=MyISAM AUTO_INCREMENT=84761 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sources` (
  ...
  KEY `so_id` (`so_id`),
  KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=27102 DEFAULT CHARSET=utf8;
...
LOAD DATA LOCAL INFILE 'ita_wikipedia_2016_30K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'ita_wikipedia_2016_30K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'ita_wikipedia_2016_30K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'ita_wikipedia_2016_30K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'ita_wikipedia_2016_30K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'ita_wikipedia_2016_30K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'ita_wikipedia_2016_30K-sources.txt' INTO TABLE sources;
