CREATE DATABASE `fra_newscrawl_2014_30K`;

USE fra_newscrawl_2014_30K;
...
CREATE TABLE `words` (
  ...
  KEY `word` (`word`),
  KEY `w_id` (`w_id`)
) ENGINE=MyISAM AUTO_INCREMENT=67473 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sources` (
  ...
  KEY `so_id` (`so_id`),
  KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=28164 DEFAULT CHARSET=utf8;
...
LOAD DATA LOCAL INFILE 'fra_newscrawl_2014_30K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'fra_newscrawl_2014_30K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'fra_newscrawl_2014_30K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'fra_newscrawl_2014_30K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'fra_newscrawl_2014_30K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'fra_newscrawl_2014_30K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'fra_newscrawl_2014_30K-sources.txt' INTO TABLE sources;
